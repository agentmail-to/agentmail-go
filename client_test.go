...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Inboxes.List(context.Background(), agentmail.InboxListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Inboxes.List(cancelCtx, agentmail.InboxListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Inboxes.List(deadlineCtx, agentmail.InboxListParams{})
		if err == nil {
